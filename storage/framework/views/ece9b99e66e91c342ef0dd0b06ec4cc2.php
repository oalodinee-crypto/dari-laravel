<?php $__env->startSection('title', 'لوحة التحكم - الإدارة'); ?>
...
<div class="row g-4 mb-4">
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-dark"><?php echo e(number_format($stats['total_revenue'])); ?></h3>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-dark"><?php echo e(number_format($stats['monthly_revenue'])); ?></h3>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="<?php echo e(route('units.index')); ?>" class="text-decoration-none">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">نسبة الإشغال</p>
                        <h3 class="mb-0 fw-bold text-dark"><?php echo e($stats['occupancy_rate']); ?>%</h3>
                        <div class="progress progress-stat mt-2" style="width: 100px;">
                            <div class="progress-bar bg-info" style="width: <?php echo e($stats['occupancy_rate']); ?>%"></div>
                        </div>
                    </div>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="<?php echo e(route('contracts.index')); ?>" class="text-decoration-none">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">العقود النشطة</p>
                        <h3 class="mb-0 fw-bold text-dark"><?php echo e($stats['active_contracts']); ?></h3>
                        <small class="text-warning"><?php echo e($stats['expiring_contracts']); ?> تنتهي قريباً</small>
                    </div>
...
<div class="row g-4 mb-4">
    <div class="col-md-6 col-xl-3">
        <a href="<?php echo e(route('buildings.index')); ?>" class="text-decoration-none">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">إجمالي المباني</p>
                        <h3 class="mb-0 fw-bold text-dark"><?php echo e($stats['total_buildings']); ?></h3>
                        <small class="text-primary"><?php echo e($stats['total_units']); ?> وحدة</small>
                    </div>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="<?php echo e(route('maintenance.index')); ?>" class="text-decoration-none">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">طلبات الصيانة</p>
                        <h3 class="mb-0 fw-bold text-warning"><?php echo e($stats['pending_maintenance']); ?></h3>
                        <small class="text-info"><?php echo e($stats['in_progress_maintenance']); ?> قيد التنفيذ</small>
                    </div>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-danger"><?php echo e($stats['overdue_invoices']); ?></h3>
                        <small class="text-danger"><?php echo e(number_format($stats['overdue_amount'])); ?> ر.س</small>
                    </div>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-dark"><?php echo e($stats['total_users']); ?></h3>
                        <small class="text-success">+<?php echo e($stats['new_users_month']); ?> هذا الشهر</small>
                    </div>
    ...
    <div class="col-lg-8">
        <div class="chart-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary"><?php echo e(now()->year); ?></span>
            </div>
            <div class="card-body">
        ...
        <div class="card alert-card border-warning">
            <div class="card-header bg-warning bg-opacity-10 border-0">
                <h6 class="mb-0 fw-bold text-warning">
                    ...
                    عقود تنتهي قريباً (<?php echo e(count($expiringContracts)); ?>)
                </h6>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $expiringContracts->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($contract->tenant->name ?? '-'); ?></td>
                                <td><?php echo e($contract->unit->unit_number ?? '-'); ?></td>
                                <td><span class="badge bg-warning"><?php echo e($contract->end_date); ?></span></td>
                            </tr>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($payment->payment_number ?? '#' . $payment->id); ?></td>
                                <td class="fw-bold text-success"><?php echo e(number_format($payment->amount)); ?> ر.س</td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="d-flex align-items-center p-2 bg-light rounded">
                            ...
                            <div>
                                <p class="mb-0 small"><?php echo e($activity->description ?? 'نشاط'); ?></p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartsData = <?php echo json_encode($chartsData, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\سنة ثالثة ترم ثاني\العملي\لارافل عملي\dari-laravel\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>