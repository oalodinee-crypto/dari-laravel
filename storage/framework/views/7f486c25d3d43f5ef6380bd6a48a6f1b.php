...
const userData = {
    name: '<?php echo e(auth()->user()->name ?? "الساكن"); ?>',
    unit: '<?php echo e(auth()->user()->contracts->first()->unit->unit_number ?? "غير محدد"); ?>',
    building: '<?php echo e(auth()->user()->contracts->first()->unit->building->name ?? "غير محدد"); ?>'
};
...
<?php /**PATH D:\New folder (2)\dari-laravel\resources\views/components/chatbot.blade.php ENDPATH**/ ?>