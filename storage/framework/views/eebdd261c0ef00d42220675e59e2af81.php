...
<head>
    ...
    <title><?php echo e(__('messages.login')); ?> - <?php echo e(config('app.name', 'DARI')); ?></title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .outlined-group label {
            position: absolute;
            <?php echo e(app()->getLocale() == 'ar' ? 'right' : 'left'); ?>: 15px;
            top: 50%;
        ...
        .outlined-group .input-icon {
            position: absolute;
            <?php echo e(app()->getLocale() == 'ar' ? 'left' : 'right'); ?>: 15px;
            top: 50%;
            transform: translateY(-50%);
            color: #6c757d;
            font-size: 1.1rem;
...
<body>
    ...
    <div class="lang-switcher">
        <div class="lang-dropdown" onclick="toggleLangMenu()">
            <span><?php echo e(app()->getLocale() == 'ar' ? 'العربية' : 'English'); ?></span>
            <i class="bi bi-chevron-down"></i>
        </div>
        <div class="lang-menu" id="langMenu">
            <a href="<?php echo e(url('language/ar')); ?>" class="<?php echo e(app()->getLocale() == 'ar' ? 'active' : ''); ?>">العربية</a>
            <a href="<?php echo e(url('language/en')); ?>" class="<?php echo e(app()->getLocale() == 'en' ? 'active' : ''); ?>">English</a>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="options-row">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="remember"><?php echo e(app()->getLocale() == 'ar' ? 'تذكرني' : 'Remember me'); ?></label>
                </div>
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>"><?php echo e(app()->getLocale() == 'ar' ? 'نسيت كلمة المرور؟' : 'Forgot password?'); ?></a>
                <?php endif; ?>
            </div>

            <button type="submit" class="btn btn-primary">
                <i class="bi bi-box-arrow-in-<?php echo e(app()->getLocale() == 'ar' ? 'left' : 'right'); ?> me-2"></i><?php echo e(__('messages.login')); ?>

            </button>
        </form>

        <div class="divider"><span><?php echo e(app()->getLocale() == 'ar' ? 'أو' : 'or'); ?></span></div>
        ...
        <div class="auth-footer">
            <?php echo e(app()->getLocale() == 'ar' ? 'ليس لديك حساب؟' : "Don't have an account?"); ?> <a href="<?php echo e(route('register')); ?>"><?php echo e(__('messages.register')); ?></a>
        </div>
    </div>
...
<?php /**PATH D:\سنة ثالثة ترم ثاني\العملي\لارافل عملي\dari-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>