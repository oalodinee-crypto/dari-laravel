...
const knowledgeBase = {
    ...
    maintenance: {
        ...
        actions: [{text: '🔧 طلب صيانة', url: '/resident/my-maintenance'}, {text: '📞 اتصال طوارئ', url: 'tel:775028636'}]
    },
    ...
    electricity: {
        ...
        actions: [{text: '🔧 طلب صيانة', url: '/resident/my-maintenance'}, {text: '📞 طوارئ', url: 'tel:775028636'}]
    },
    ...
    contact: {
        ...
        actions: [{text: '✉️ إرسال رسالة', url: '/messages/create'}, {text: '📞 اتصال', url: 'tel:775028636'}]
    },
    ...
    security: {
        ...
        actions: [{text: '📞 طوارئ', url: 'tel:775028636'}]
    },
